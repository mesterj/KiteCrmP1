...
public class CallEndReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // ha a hívás befejezõdik és még nem volt ilyen számmal senki a telefonkönyvben akkor elõször az új kapcsolat felvitléhez való képernyõ indul el, benne a telefonszámmal.
